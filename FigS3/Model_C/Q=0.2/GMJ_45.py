...
plt.semilogy(- w * conv, k_Marcus_inn * conv, '-', linewidth = 3, color = "orange", label = r'Inside Cavity (GMJ, $\mathcal{Q}$ = 0.2)')
...
ax.set_xlabel(r'- $\Delta$ G_$0$ (eV)', font = 'Times New Roman', size = 20)
...
plt.savefig("Model_C_Q = 0.2_GMJ_45.pdf", bbox_inches='tight')