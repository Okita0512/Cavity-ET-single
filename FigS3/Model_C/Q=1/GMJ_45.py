...
plt.semilogy(- w * conv, k_Marcus_inn * conv, '-', linewidth = 3, color = "orange", label = r'Inside Cavity (GMJ, $\mathcal{Q}$ = 1)')
...
plt.savefig("Model_C_Q = 1_GMJ_45.pdf", bbox_inches='tight')