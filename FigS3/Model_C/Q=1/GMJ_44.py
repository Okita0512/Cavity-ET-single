...
plt.semilogy(- w * conv, k_Marcus_in2 * conv, '-', linewidth = 3, color = "orange", label = r'Inside Cavity (GMJ, $\mathcal{Q}$ = 1)')

data1 = np.loadtxt("dG", dtype = float)
data2 = np.loadtxt("k_in", dtype = float)
plt.semilogy(- data1, data2, 'o', markersize = 6, markeredgewidth = 2, markeredgecolor = "#0385FF", markerfacecolor = '#0385FF', label = r'Inside Cavity (FGR, $\mathcal{Q}$ = 1)')
...
plt.savefig("Model_C_Q = 1_GMJ_44.pdf", bbox_inches='tight')