...
def DFT(w_c, Gamma_c):
    ...
    ndof_c = 5000    # make sure error of reorg < 1%
...
plt.semilogy(- t * conv, y_c * conv, '-', linewidth = 2.5, color = 'orange', label = r'$\mathcal{Q} = 0.01$') # , label = r'$200$ meV'
...
plt.savefig("Q = 0.01.pdf", bbox_inches='tight')