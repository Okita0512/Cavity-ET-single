...
plt.semilogy(- w * conv, k_Marcus_in2 * conv, '--', linewidth = 3, color = "orange", label = 'Marcus Inside Cavity_Q = 0.01')
...
plt.savefig("Q = 0.01_test.pdf", bbox_inches='tight')