...
plt.semilogy(- w * conv, k_Marcus_in2 * conv, '--', linewidth = 3, color = "orange", label = 'Marcus Inside Cavity_Q = 0')
...
plt.savefig("Q = 0_test.pdf", bbox_inches='tight')