...
print("the value of FC_01:", FC(0, 1)**2)
print("the value of FC_02:", FC(0, 2)**2)
print("the value of FC_03:", FC(0, 3)**2)
...
# ==============================================================================
plt.semilogy(- w * conv, k_Marcus_out * conv, '-', linewidth = 3, color = '#444444', label = 'Outside Cavity (MJ)')
...
plt.savefig("Model B - meidum T.pdf", bbox_inches='tight')