...
plt.semilogy(- w * conv, k_Marcus_in2 * conv, '--', linewidth = 3, color = "orange", label = 'Marcus Inside Cavity_Q = 5')
...
ax.legend(loc = 'lower left', prop = font, bbox_to_anchor = (0.1, 0), markerscale = 1, frameon = False)
plt.legend(frameon = False)

# plt.show()

plt.savefig("Q = 5_test.pdf", bbox_inches='tight')